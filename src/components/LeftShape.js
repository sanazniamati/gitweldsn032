...
function LeftShape({ b, f, h, j, k }) {
  return (
    <Group>
      <Line stroke={"green"} strokeWidth={2} points={[154, b, 248, b]} />
      <Arrow
        ...
        strokeWidth={3}
      />
      <Line stroke={"green"} strokeWidth={2} points={[154, 426, 248, 426]} />
      <Text x={168} y={k - 20} text={"t2"} fontSize={40} />
